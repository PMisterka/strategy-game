...
namespace StrategyGame
{
    class Battle3
    {
        ...
        {
            EnemyFactory3 enemyFactory3 = new EnemyFactory3();

            Random rnd = new Random();
            int r = rnd.Next(1, 4);
            enemyFactory3.rndEnemy(r);
            enemyFactory3.rndEnemy(r).Health().ToString();
            quan = enemyFactory3.rndEnemy(r).Quantity();
            int oneEnemyHP = enemyFactory3.rndEnemy(r).Health();
            double Estr = enemyFactory3.rndEnemy(r).Strength();
            //double EnemyBonus = enemyFactory3.rand;
            ...
            for (int i = 1; i < 5; i++)
            {
                ...
                switch (i)
                {
                    case 1:
                        ...
                        //int enemyHP = enemyFactory3.rndEnemy(r).Health() * enemyFactory3.rndEnemy(r).Quantity();
