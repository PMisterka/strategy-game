...
namespace StrategyGame
{
    class Battle1
    {
        ...
        {
            EnemyFactory1 enemyFactory1 = new EnemyFactory1();

            Random rnd = new Random();
            int r = rnd.Next(1,4);
            enemyFactory1.rndEnemy(r);
            enemyFactory1.rndEnemy(r).Health().ToString();
            quan = enemyFactory1.rndEnemy(r).Quantity(); //quantity of all enemies
            int oneEnemyHP = enemyFactory1.rndEnemy(r).Health();
            double Estr = enemyFactory1.rndEnemy(r).Strength();
            ...
            for (int i = 1;  i<5; i++) 
            {
                ...
                switch (i)
                {
                    case 1:
                        ...
                        //int enemyHP = enemyFactory1.rndEnemy(r).Health() * enemyFactory1.rndEnemy(r).Quantity();
                        ...
                        else if (ourAttack1 <= (1.05 * enemyHP) && ourAttack1 >= (0.95 * enemyHP))
                        {
                            ...
                            else
                            {
                                ...
                                if (checkIfWin < 85) // 85% chance of winning
                                {
                                    Console.WriteLine("This fight is over!");
                                    ourHP1 = (double)(ourHP1 - enemyAttack1);
                                    enemyHP = (double)(enemyHP - ourAttack1);
                        ...
                        else if (ourAttack1 <= (0.95 * enemyHP) && ourAttack1 >= (0.85 * enemyHP))
                        {
                            ...
                            {
                                int checkIfWin = rnd.Next(101);
                                if (checkIfWin < 15) // 15% chance of winning
                                {
                                    Console.WriteLine("This fight is over!");
                                    ourHP1 = (double)(ourHP1 - enemyAttack1);
                                    enemyHP = (double)(enemyHP - ourAttack1);
